...
export const ContactSection = () => {
  return (
    <div className="bg-[#0D0D0D] flex justify-center items-center h-[600px]  round[40px] gap-4 contact-section contact-container">
      <div className="w-[1459px] flex justify-center items-center flex-col pt-[142px] pb-[242px] pl-[184px] pr-[184px] ">
        ...
        <div className="flex flex-row">
          <div className="bg-[#C7C7BB] text-[#0D0D0D] flex flex-row rounded-[40px] w-[274px] h-[76px] justify-between  pr-[5px] contact-button-background">
            <div className="flex pl-16 w-full font-bold pt-[16px] pb-[16px]  pl-[16px] contact-button-text">
